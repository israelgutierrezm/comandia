...
/**
 * Uber Eats (ADR-015). Contrato listo; adaptador real en la Fase 3 (convenio + credenciales).
 */
final class UberEatsChannel implements MarketplaceChannel
{
    public function name(): string
    {
        return DeliveryChannelType::UberEats->value;
    }

    public function parseWebhook(Request $request, DeliveryChannelSetting $settings): IngestedOrder
    {
        throw new MarketplaceChannelNotWired(DeliveryChannelType::UberEats->label());
    }
