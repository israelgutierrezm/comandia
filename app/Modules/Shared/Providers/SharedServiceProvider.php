...
final class SharedServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        // que nunca es peor que mandarlo a la impresora equivocada. `PosServiceProvider` enlaza la implementación real.
        $this->app->bind(AreaRouter::class, NullAreaRouter::class);
