...
export const ACTION_ICONS = {
    ...
    box: ['M3 8 12 4l9 4-9 4-9-4Z', 'M3 8v8l9 4 9-4V8', 'M12 12v8'],
    truck: ['M3 6h11v9H3z', 'M14 9h4l3 3v3h-2', 'M8 18a1.5 1.5 0 1 0-3 0 1.5 1.5 0 0 0 3 0Z', 'M19 18a1.5 1.5 0 1 0-3 0 1.5 1.5 0 0 0 3 0Z'],
    ...
    swap: ['M4 9h14', 'M15 6l3 3-3 3', 'M20 15H6', 'M9 12l-3 3 3 3'],
    dots: [
        'M10.9 6a1.1 1.1 0 1 0 2.2 0 1.1 1.1 0 1 0 -2.2 0',
        'M10.9 12a1.1 1.1 0 1 0 2.2 0 1.1 1.1 0 1 0 -2.2 0',
        'M10.9 18a1.1 1.1 0 1 0 2.2 0 1.1 1.1 0 1 0 -2.2 0',
    ],
};
